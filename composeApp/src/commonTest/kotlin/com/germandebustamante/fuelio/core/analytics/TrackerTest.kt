...
class TrackerTest {
    ...
    @Test
    fun `track - GIVEN an Event trace WHEN track THEN only onTrackEvent is called`() {
    ...
    @Test
    fun `track - GIVEN a Screen trace WHEN track THEN only onTrackScreen is called`() {
    ...
    @Test
    fun `track - GIVEN an Error trace WHEN track THEN only onTrackError is called`() {
