...
struct AccessibilityIdentifierContractTests {
    ...
    func staticIdentifiersMatch() {
        ...
        #expect(A11yID.favoritesBackButton == "favorites_back_button")
        #expect(A11yID.favoritesEmpty == "favorites_empty")
        #expect(A11yID.favoritesUnresolvedBanner == "favorites_unresolved_banner")
